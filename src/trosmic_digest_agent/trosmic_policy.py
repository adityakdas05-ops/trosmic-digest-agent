...
SPORTS_FIRST_QUERY_GROUPS = {
    ...
    "india_sports": [
        "latest IPL BCCI media rights sponsorship",
        "latest WPL viewership sponsorship rights",
        "latest Pro Kabaddi League media rights sponsorship",
        "latest kabaddi international federation",
        "latest Indian sports business",
    ],
    "global_leagues": [
        "latest UFC TKO media rights sponsorship",
        "latest WWE Netflix sports entertainment deal",
        ...
        "latest FIFA IOC commercial rights sponsorship",
    ],
    "gcc": [
        "latest Saudi sports investment",
        "latest UAE sports investment",
        "latest Dubai sports entertainment venue investment",
        "latest Qatar sports investment",
        "latest GCC sports infrastructure investment",
    ],
    "fan_data": [
